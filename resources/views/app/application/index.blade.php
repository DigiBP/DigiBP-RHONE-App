...
@section('content')
    ...
    <div class="md:w-1/2 md:mx-auto mt-24">
        <div class="p-6">
            ...
            <div class="font-bold text-xl">  {{ __('app/application.title') }}</div>
            <div class="font-light text-lg mb-2">  {{ __('app/application.subtitle') }}</div>




            <form class="mt-6" method="POST" action="{{ route('application.update') }}">
                @csrf
